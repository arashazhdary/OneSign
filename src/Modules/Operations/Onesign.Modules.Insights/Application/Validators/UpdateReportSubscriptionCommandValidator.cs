...
public class UpdateReportSubscriptionCommandValidator : AbstractValidator<UpdateReportSubscriptionCommand>
{
    public UpdateReportSubscriptionCommandValidator()
    {
        RuleFor(x => x.Id)
