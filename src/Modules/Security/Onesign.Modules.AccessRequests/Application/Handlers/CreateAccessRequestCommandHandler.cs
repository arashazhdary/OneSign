...
public class CreateAccessRequestCommandHandler : IRequestHandler<CreateAccessRequestCommand, Result<AccessRequestDto>>
{
    private readonly IAccessRequestRepository _repository;
    private readonly IWorkflowEngine _workflowEngine;

    public CreateAccessRequestCommandHandler(IAccessRequestRepository repository, IWorkflowEngine workflowEngine)
    {
        _repository = repository;
        _workflowEngine = workflowEngine;
    }

    public async Task<Result<AccessRequestDto>> Handle(CreateAccessRequestCommand request, CancellationToken cancellationToken)
    {
