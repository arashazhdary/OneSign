...
public interface IAccessRequestRepository
{
    ...
    Task<IReadOnlyList<AccessRequest>> GetByRequesterIdAsync(Guid tenantId, Guid requesterId, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<AccessRequest>> GetByApproverIdAsync(Guid tenantId, Guid approverId, CancellationToken cancellationToken = default);
