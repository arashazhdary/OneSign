...
public class UpdateScheduledHuntCommandValidator : AbstractValidator<UpdateScheduledHuntCommand>
{
    public UpdateScheduledHuntCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("Scheduled hunt ID is required");
