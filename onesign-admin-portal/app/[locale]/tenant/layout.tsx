...
export default function TenantLayout({
  ...
  const navItems = [
    { path: '/dashboard', label: t('common.dashboard'), icon: DashboardIcon },
    { path: '/users', label: t('common.users'), icon: UsersIcon },
    { path: '/apps', label: t('common.applications'), icon: AppsIcon },
    { path: '/org-units', label: t('tenant.orgUnits.title'), icon: OrgUnitsIcon },
    { path: '/delegated-admins', label: t('tenant.delegatedAdmins.title'), icon: DelegatedAdminsIcon },
    { path: '/audit', label: t('common.audit'), icon: AuditIcon },
    { path: '/settings', label: t('common.settings'), icon: SettingsIcon },
  ];
  ...
  const phase24Items = [
    ...
    { path: '/hunting', label: 'Hunting', icon: HuntingIcon },
    { path: '/copilot', label: 'Copilot', icon: CopilotIcon },
  ];
