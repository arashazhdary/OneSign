    ...
    <div className="p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="governance/campaigns" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
              View All →
            </Link>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow-md p-6">
          ...
          <div className="space-y-2">
            <Link to="governance/campaigns" className="block text-purple-700 hover:text-purple-900 text-sm">
              → Review pending campaigns
            </Link>
            <Link to="/tenant/policies" className="block text-purple-700 hover:text-purple-900 text-sm">
              → Update policy rules
            </Link>
            <Link to="/tenant/reports" className="block text-purple-700 hover:text-purple-900 text-sm">
