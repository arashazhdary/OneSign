...
export function Footer() {
  ...
  const socialLinks = [
    {
      name: 'Twitter',
      href: 'https://twitter.com/onesign',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/onesign',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@onesign',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
